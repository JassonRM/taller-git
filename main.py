...
def fetchAboutView():
    display_about_view()
about_btn = Button(root, text="Licencia", command=fetchLicenceView, bg = "Blue", fg = "White", width = 50, height = 5)
about_btn.place(x=35,y=250)

def fetchLicenceView():
    display_about_view()
licence_btn = Button(root,text="Licencia", command=fetchLicenceView
, bg = "#000000", fg = "#ffffff", width= 50, height = 5)
